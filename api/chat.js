 ...
 *
 * Mirrors server/chat.js but as a Vercel handler.
 * Knowledge files bundled via vercel.json includeFiles.
 *
 * Required env (set in Vercel dashboard → Project → Settings → Environment Variables):
...
// Vercel Node runtime config — increase max duration for streaming
export const config = {
  maxDuration: 30,
};
